      ...
      <section className="pt-32 pb-20 md:pt-40 md:pb-28 bg-gradient-to-b from-tech-lightGray to-white">
        <div className="container-padding max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto">
            Soluciones confiables para todos tus problemas tecnológicos, respaldadas por expertos certificados
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-tech-blue text-white">
        <div className="container-padding max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              href="#contacto" 
              className="bg-white text-tech-blue hover:bg-gray-100 py-3 px-8 rounded-lg font-medium transition-all duration-300"
            >
              Contáctanos hoy
            </a>
            <a 
              ...
              className="bg-green-500 hover:bg-green-600 text-white py-3 px-8 rounded-lg font-medium transition-all duration-300 flex items-center justify-center gap-2"
            >
          ...
          <div className="glass-card rounded-2xl overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="relative hidden lg:block">
                <img 
                  src="https://images.unsplash.com/photo-1562408590-e32931084e23?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80" 
