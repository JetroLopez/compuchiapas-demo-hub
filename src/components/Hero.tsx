      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-2 gap-3 mt-4">
          <a
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-blue-500 to-cyan-500 transition-opacity duration-400 shadow-sm opacity-30" />
          ...
          <a
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-orange-500 to-amber-500 transition-opacity duration-400 shadow-sm opacity-30" />
            <div className="relative z-10 flex items-center gap-3 w-full">
              <div className="shrink-0 w-9 h-9 md:w-11 md:h-11 rounded-full bg-white/15 flex items-center justify-center">
